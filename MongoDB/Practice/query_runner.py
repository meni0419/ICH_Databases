...
queries = {
    ...
    "pr2_find_songs_by_artist": lambda: collections.Spotify_Youtube
    ...
    "pr2_find_songs_licensed": lambda: collections.Spotify_Youtube
    ...
    "pr2_find_songs_love": lambda: collections.Spotify_Youtube
    ...
    "pr2_find_songs_official_video": lambda: collections.Spotify_Youtube
    ...
    "pr2_find_bike_most_trips": lambda: collections.trips
    .aggregate([
